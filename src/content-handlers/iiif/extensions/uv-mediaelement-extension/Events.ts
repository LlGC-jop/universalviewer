export class MediaElementExtensionEvents {
  ...
  static MEDIA_MUTED: string = MediaElementExtensionEvents.namespace + 'mediaMuted';
  ...
  static MEDIA_UNMUTED: string = MediaElementExtensionEvents.namespace + 'mediaUnmuted';
}
