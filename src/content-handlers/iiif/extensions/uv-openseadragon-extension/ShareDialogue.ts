...
export class ShareDialogue extends BaseShareDialogue<Config['modules']['shareDialogue']> {
  constructor($element: JQuery) {
    ...
    this.extensionHost.subscribe(OpenSeadragonExtensionEvents.OPENSEADRAGON_ANIMATION_FINISH, () => {
      this.update();
    });
  }
  ...
  update(): void {
    ...
    this.embedCode = (<OpenSeadragonExtension>this.extension).getEmbedScript(this.options.embedTemplate, this.currentWidth, this.currentHeight, xywh, rotation);
