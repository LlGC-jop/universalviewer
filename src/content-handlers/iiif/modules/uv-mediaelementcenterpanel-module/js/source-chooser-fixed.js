              ...
              if (t.options.keyActions.length) {
                ...
                switch (keyCode) {
                  ...
                  case 32: // Space Bar
                    ...
                    } else if (document.activeElement.matches('input[type="radio"]') && player.sourcechooserButton.contains(document.activeElement)) {
                  ...
                  case 9: // Tab
                    if (player.isSourcechooserSelectorOpen()) {
                      ...
                      if (checked.matches('input[type="radio"]') && player.sourcechooserButton.contains(checked)) {
                  ...
                  case 40: // Down Arrow
                    ...
                    if (document.activeElement.matches('input[type="radio"]') && player.sourcechooserButton.contains(document.activeElement)) {
