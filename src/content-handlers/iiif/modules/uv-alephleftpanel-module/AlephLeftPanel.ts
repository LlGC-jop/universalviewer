...
export class AlephLeftPanel extends LeftPanel<Config['modules']['alephLeftPanel']> {
  ...
  async create(): Promise<void> {
    ...
    this.extensionHost.subscribe(AlephExtensionEvents.VIEWER_CHANGE, (state: any) => {
    ...
    this._alControlPanel.addEventListener(
      ...
      (e: any) => {
        this.extensionHost.publish(AlephExtensionEvents.BOUNDING_BOX_ENABLED_CHANGE, e.detail);
      },
      false,
    );
    ...
    this._alControlPanel.addEventListener(
      'controlsTypeChange',
      (e: any) => {
        this.extensionHost.publish(AlephExtensionEvents.CONTROLS_TYPE_CHANGE, e.detail);
      },
      false,
    );
    ...
    this._alControlPanel.addEventListener(
      'displayModeChange',
      (e: any) => {
        this.extensionHost.publish(AlephExtensionEvents.DISPLAY_MODE_CHANGE, e.detail);
      },
      false,
    );
    ...
    this._alControlPanel.addEventListener(
      'graphEnabledChange',
      (e: any) => {
        this.extensionHost.publish(AlephExtensionEvents.GRAPH_ENABLED_CHANGE, e.detail);
      },
      false,
    );
    ...
    this._alControlPanel.addEventListener(
      'orientationChange',
      (e: any) => {
        this.extensionHost.publish(AlephExtensionEvents.ORIENTATION_CHANGE, e.detail);
      },
      false,
    );
    ...
    this._alControlPanel.addEventListener(
      'slicesIndexChange',
      (e: any) => {
        this.extensionHost.publish(AlephExtensionEvents.SLICES_INDEX_CHANGE, e.detail);
      },
      false,
    );
    ...
    this._alControlPanel.addEventListener(
      ...
      (e: any) => {
        this.extensionHost.publish(AlephExtensionEvents.VOLUME_BRIGHTNESS_CHANGE, e.detail);
      },
      false,
    );
    ...
    this._alControlPanel.addEventListener(
      ...
      (e: any) => {
        this.extensionHost.publish(AlephExtensionEvents.VOLUME_CONTRAST_CHANGE, e.detail);
      },
      false,
    );
    ...
    this._alControlPanel.addEventListener(
      'volumeStepsChange',
      (e: any) => {
        this.extensionHost.publish(AlephExtensionEvents.VOLUME_STEPS_CHANGE, e.detail);
      },
      false,
    );
