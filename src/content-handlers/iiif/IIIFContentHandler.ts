...
import { RenderingFormat, MediaType, ExternalResourceType } from '@iiif/vocabulary/dist-commonjs/';
...
const Extension: IExtensionRegistry = {
  AV: {
    ...
    loader: () => /* webpackMode: "lazy" */ import('./extensions/uv-av-extension/Extension'),
  },
  ALEPH: {
    name: 'uv-aleph-extension',
    loader: () => /* webpackMode: "lazy" */ import('./extensions/uv-aleph-extension/Extension'),
  },
  DEFAULT: {
    name: 'uv-default-extension',
    loader: () => /* webpackMode: "lazy" */ import('./extensions/uv-default-extension/Extension'),
  },
  EBOOK: {
    name: 'uv-ebook-extension',
    loader: () => /* webpackMode: "lazy" */ import('./extensions/uv-ebook-extension/Extension'),
  },
  MEDIAELEMENT: {
    name: 'uv-mediaelement-extension',
    loader: () => /* webpackMode: "lazy" */ import('./extensions/uv-mediaelement-extension/Extension'),
  },
  MODELVIEWER: {
    name: 'uv-model-viewer-extension',
    loader: () => /* webpackMode: "lazy" */ import('./extensions/uv-model-viewer-extension/Extension'),
  },
  OSD: {
    name: 'uv-openseadragon-extension',
    loader: () => /* webpackMode: "lazy" */ import('./extensions/uv-openseadragon-extension/Extension'),
  },
  PDF: {
    name: 'uv-pdf-extension',
    loader: () => /* webpackMode: "lazy" */ import('./extensions/uv-pdf-extension/Extension'),
  },
  SLIDEATLAS: {
    name: 'uv-openseadragon-extension',
    loader: () => /* webpackMode: "lazy" */ import('./extensions/uv-openseadragon-extension/Extension'),
...
export default class IIIFContentHandler extends BaseContentHandler<IIIFData> implements IIIFExtensionHost, IContentHandler<IIIFData> {
  ...
  private async _getExtensionByType(type: ExtensionLoader, format?: string): Promise<any> {
  ...
  public set(data: IUVData<any>, initial?: boolean): void {
    ...
    if (!this.extension) {
      ...
      const newData: IUVData<any> = Object.assign({}, this.extension.data, data);
      if (
        newData.isReload ||
  ...
  private async _loadAndApplyConfigToExtension(that: IIIFContentHandler, data: IUVData<any>, extension: any): Promise<void> {
    ...
    let config = await extension.loadConfig(data.locales[0].name, extension?.type.name);
  ...
  private async _reload(data: IUVData<any>): Promise<void> {
    ...
    try {
      ...
      if (extension!.type === Extension.AV && (!hasRanges || data.config.options.preferMediaElementExtension)) {
        extension = await that._getExtensionByType(Extension.MEDIAELEMENT, format);
        await this._loadAndApplyConfigToExtension(that, data, extension);
      }
  ...
  private _createExtension(extension: any, data: IUVData<any>, helper: Helper): void {
